...
const createEntity = (entityName, info, InsertExpression, UpdateExpression, DeleteExpression) => {
...
class Schema {
  constructor (definition, InsertExpression, UpdateExpression) {
    Object.keys(definition.entities).forEach(entityName => {
      let entity = createEntity(entityName, definition.entities[entityName], InsertExpression, UpdateExpression)
